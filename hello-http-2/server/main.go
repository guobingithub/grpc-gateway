...
func main() {
	...
	// grpc server
	creds, err := credentials.NewServerTLSFromFile("C:/My/gopath/src/grpc-gateway/keys/server.pem", "C:/My/gopath/src/grpc-gateway/keys/server.key")
	if err != nil {
	...
	dcreds, err := credentials.NewClientTLSFromFile("C:/My/gopath/src/grpc-gateway/keys/server.pem", "server name")
	if err != nil {
...
func getTLSConfig() *tls.Config {
	cert, _ := ioutil.ReadFile("C:/My/gopath/src/grpc-gateway/keys/server.pem")
	key, _ := ioutil.ReadFile("C:/My/gopath/src/grpc-gateway/keys/server.key")
